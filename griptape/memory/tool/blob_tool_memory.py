...
class BlobToolMemory(BaseToolMemory):
    driver: BaseBlobToolMemoryDriver = field(
        default=Factory(lambda: LocalBlobToolMemoryDriver()), kw_only=True
    )
    ...
    def process_output(
        ...
        if isinstance(output_artifact, BlobArtifact):
            ...
            output_artifact, ListArtifact
        ) and output_artifact.is_type(BlobArtifact):
    ...
    def load_artifacts(self, namespace: str) -> ListArtifact:
        return ListArtifact(self.driver.load(namespace))
